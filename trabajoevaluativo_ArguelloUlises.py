...
while True: #Menu de opciones para el usuario
    ...
    print("10. Convertir todos los nombres con minusculas y mayusculas")
    ...
    if opcion == "1":#Imprime todos los nombres con el orden que fueron ingresados
        ...
        nombres_ordenados = sorted(nombres) #utiliza la funcion sorted para obtener una lista ordenada
    ...
    elif opcion == "10":#Ciclo para convertir todos los nombres a mayusculas y minusculas
    ...
    elif opcion == "11":#Ciclo para salir del programa
        print("-------------------------------------------------------------------")
